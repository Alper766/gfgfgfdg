...
.setCustomId('form')
.setTitle('Balt Development- Destek Sistemi!')
...
const embed = new EmbedBuilder()
.setTitle('Balt Development - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('Balt Development - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("Balt Development - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("Balt Development - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle " Balt Development - Kullanıcı Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    if (interaction.values[0] == "giveaway") {
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Balt Development - Çekiliş Sistemi!")
...
.setCustomId('formaq')
.setTitle('Balt Development - Başvuru Formu!')
